		...
		<div class="row-fluid">
			<div class="col-sm-12" style="background-color: #314140;">
				<p style="color: #ffffff;">
					...
					Desktop <span class="pull-right"><span class="glyphicon glyphicon-user"></span>user:
					${userName} <a href="logout" class="btn btn-link" role="button">logout</a></span>
				</p>
			</div>
		</div>
		<div class="row-fluid">
				...
				<div class="panel-group" id="accordion">
					 ...
					 */
					 ...
					 function updateAgent(){
						 $.ajax({
						        url: "/spring-web-bootstrap/agent/updateStatus",
						        type: 'post',
						        dataType: 'json',
						        contentType: 'application/json',
						        data: JSON.stringify({name:"${userName}", status:$("#selOne").val()}),
						        success: loadAgents()
						    });
					 }
					    ...
					    $.ajax("/agents", {
					        ...
					        success: function(data) {
					            ...
					            $.each(data, function(index, item) {
					                $("#agents").append($("<li>").text(item.name +", "+ item.password +", "+ item.status));
					            });
					        }
					    });
					}
							...
							<div class="row-fluid">
								<div class="col-sm-12">
									<img style="float: left;"
										src="C:\Users\mkat1564\Desktop\linux.jpg" class="thumbnail"
							...
							<div class="row">
								...
								<div class="col-sm-6" align="right">
									<a href="#" class="btn btn-primary " data-toggle="tooltip"
										data-placement="top" title="Accept"><i
										class="glyphicon glyphicon-earphone"></i></a> <a href="#"
										class="btn btn-warning " data-toggle="tooltip"
										data-placement="top" title="Hold"><i
										class="glyphicon glyphicon-phone-alt"></i></a> <a href="#"
				...
				<div class="panel-group" id="accordionOuter">
					...
					<div class="panel panel-primary">
						...
						<div id="accordionII" class="panel panel-collapse in">
							<div class="panel-body">Customer video has to be
								Implemented <br />
